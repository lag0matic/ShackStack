...
internal static class MmsstvModeCatalog
{
    ...
    [
        ...
        new(SstvModeId.Robot72, "Robot 72", 0x0C, 320, 240, 72_000.0 / 1000.0, false, false, true),
        ...
        new(SstvModeId.Scottie2, "Scottie 2", 0x38, 160, 256, 277_692.0 / 1000.0, false, true, true,
        ...
        new(SstvModeId.Martin2, "Martin 2", 0x28, 160, 256, 226_798.0 / 1000.0, false, true, true,
        ...
        new(SstvModeId.Pd50, "PD 50", 0x5D, 320, 256, 388_160.0 / 1000.0, false, false, true,
            "pd", 20.0, 0.0, 0.0, 0.0, 2.08, 0.0, 0.286),
        new(SstvModeId.Pd90, "PD 90", 0x63, 320, 256, 703_040.0 / 1000.0, false, false, true,
        ...
        new(SstvModeId.Pd160, "PD 160", 0x62, 512, 400, 804_416.0 / 1000.0, false, false, true,
            "pd", 20.0, 0.0, 0.0, 0.0, 2.08, 0.0, 0.382),
        new(SstvModeId.Pd180, "PD 180", 0x60, 640, 496, 754_240.0 / 1000.0, false, false, true,
            "pd", 20.0, 0.0, 0.0, 0.0, 2.08, 0.0, 0.286),
        new(SstvModeId.Pd240, "PD 240", 0x61, 640, 496, 1_000_000.0 / 1000.0, false, false, true,
            "pd", 20.0, 0.0, 0.0, 0.0, 2.08, 0.0, 0.382),
        new(SstvModeId.Pd290, "PD 290", 0x5E, 800, 616, 937_280.0 / 1000.0, false, false, true,
            "pd", 20.0, 0.0, 0.0, 0.0, 2.08, 0.0, 0.286),
        ...
        new(SstvModeId.Robot24, "Robot 24", 0x00, 160, 120, 24_000.0 / 1000.0, false, false, true),
        ...
        new(SstvModeId.WraseMn73, "MN 73", 0x8D, 320, 256, 73_000.0 / 1000.0, false, false, true),
        new(SstvModeId.WraseMn110, "MN 110", 0x8E, 320, 256, 110_000.0 / 1000.0, false, false, true),
        new(SstvModeId.WraseMn140, "MN 140", 0x8F, 320, 256, 140_000.0 / 1000.0, false, false, true),
        new(SstvModeId.WraseMc110, "MC 110", 0x90, 320, 256, 110_000.0 / 1000.0, false, false, true),
        new(SstvModeId.WraseMc140, "MC 140", 0x91, 320, 256, 140_000.0 / 1000.0, false, false, true),
        new(SstvModeId.WraseMc180, "MC 180", 0x92, 320, 256, 180_000.0 / 1000.0, false, false, true),
    ];
    ...
    public static bool TryResolveVis(int visCode, out SstvModeProfile profile)
        => ByVisInternal.TryGetValue(visCode, out profile!);
